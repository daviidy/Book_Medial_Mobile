...
class HomeViewModel extends BaseViewModel {
  ...
  String? _profilPhoto;
  LocalStorage storageMe = new LocalStorage('book_medial');
  ...
  onDestination(context) async {
    ...
    // print(res);
    if (res != null && res is PlacesSearchResult) {
      ...
      if (res != null && res != "" && res != " ") {
        this.sPropParam.locationValue = res.toString();
        this.sPropParam.location = res.toString();
      }
    }
  }
  ...
  Future<String?> mevalue() async {
    dynamic mevalue = await storageMe.getItem('medial_val');
    return mevalue;
  }
}
